...
from ZelzalMusic import (Apple, Resso, SoundCloud, Spotify, Telegram, YouTube)
...
async def ytsearch(_, message: Message):
    ...
    try:
        if len(message.command) < 2:
            return await message.reply_text("يمكن البحث عبر ماتركـس")
